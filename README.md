# LAGOON-MCL: LArGe Comparative Omics Network - Markov CLustering
...
LArGe cOmparative Omics Networks (LAGOON) Markov CLustering (MCL) is developed by the [Atelier de BioInformatique](https://bioinfo.mnhn.fr/abi/presentation.FR.html) team of the [Institut de Systématique, Évolution, Biodiversité - UMR 7205](https://isyeb.mnhn.fr/fr) ([National Museum of Natural History](https://www.mnhn.fr/fr), Paris, France).\
